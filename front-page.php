...
get_header(); ?>
    ...
    <section id="hero" data-vide-bg="<?php echo get_template_directory_uri(); ?>/assets/dist/images/bg-video/LJC_BG_WEB" data-vide-options="loop: true, muted: true, position: 0% 0%, className: ljcbgweb" >
