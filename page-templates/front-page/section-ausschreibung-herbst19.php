			...
			<article id="post-<?php the_ID(); ?>" <?php post_class('phase-front container'); ?> >
				<div class="row justify-center">
					...
					<div class="col-lg-4 col-md-6">
						...
						Wir können nur Personen aufnehmen, die an der gesamten Arbeits- und Konzertphase vollumfänglich teilnehmen. Durch die Bewerbung besteht noch kein Anspruch auf Teilnahme.
